	...
	<div class="container" style="width: 80%;">
		<form action="" method="post" role="form" enctype="multipart/form-data">
			...
			<div class="form-group">
				...
				<input type="file" id="avatar" name="avatar" <?php echo ($_SESSION['serv'] === false) ? 'disabled="disabled" ' : ''; ?>/>
			...
			<div class="form-group">
				...
				<input type="file" id="background" name="background" <?php echo ($_SESSION['serv'] === false) ? 'disabled="disabled" ' : ''; ?>/>
				<?php echo ($_SESSION['serv'] === false) ? '<p style="color:red">Upload indisponible. <a href="upload">Plus d\'infos ici</a></p>' : ''; ?>
