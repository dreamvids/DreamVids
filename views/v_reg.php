<div class="container">
	...
	<div class="container">
		<h1 class="title"><?php echo $lang['reg']; ?></h1>
	</div>
	...
	<div class="container" style="width: 40%; float: left;">
		...
		<form role="form" action="" method="post">
			<div class="form-group">
				...
				<input type="email" required="" placeholder="<?php echo $lang['email_address']; ?>" name="email" value="<?php echo @secure($_POST['email']); ?>" class="form-control"/>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<input type="password" required="" placeholder="<?php echo $lang['password']; ?>" name="pass1" value="<?php echo @secure($_POST['pass1']); ?>" class="form-control" />
			</div>
			<div class="form-group">
				<label for="pass2"><?php echo $lang['password_confirm']; ?></label>
				<input type="password" required="" placeholder="<?php echo $lang['password_confirm']; ?>" name="pass2" value="<?php echo @secure($_POST['pass2']); ?>" class="form-control" />
			</div>
