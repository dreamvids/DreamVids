...
<div class="container">
	...
	?>
		<a href="https://twitter.com/share" class="twitter-share-button" data-text="''<?php echo (strlen($title) > 50) ? substr($title, 0, 50).'...' : $title; ?>'' sur @DreamVids_ ! Check this out ! http://dreamvids.fr/page=watch&vid=<?php echo htmlspecialchars($_GET['vid']); ?>" data-lang="fr">Tweeter</a>
