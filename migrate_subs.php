...
DEFINE('DOIT', false);
	...
	echo "#This script will not modify other tables.\n\n";
if(!DOIT){
...
while($current = $stmt->fetch(PDO::FETCH_ASSOC)){ //On recupert chaque user un par un

	$subs = explode(';',trim($current['subscriptions'], ';')); //On recupert les subs
