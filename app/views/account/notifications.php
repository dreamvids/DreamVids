...
<div class="content">
	...
	<section class="profile">
		...
		<form class="form" method="post" action="<?php echo WEBROOT.'account/notifications'; ?>" enctype="multipart/form-data">
			...
			<br>
			<label for="pm">Être notifier lorsqu'une de mes vidéos est mise en avant par DreamVids : <input type="checkbox" value="1" name="staff_select" <?php echo $staff_select ? "checked" : "unchecked"; ?> /></label>
			<br>
