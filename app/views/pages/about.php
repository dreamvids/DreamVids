	...
	<h3 class="title">L'équipe</h3>
		<div style="margin-bottom:50px">
			...
			<p style="padding-left:70px">
				<b>Dorian</b><br />
				Darkwos, 17 ans, lycéen en filière ES, je suis passionné d'informatique,
				de design, de jeux vidéo depuis toujours. Co-fondateur et web designer de DreamVids.
			</p>
		</div>
		<div style="margin-bottom:50px">
			<div style="float:left">
			...
			<p style="padding-left:70px">
				<b>Jeremy</b><br />
				Jeremy, 15 ans, je gère sur DreamVids le community management (Twitter/Facebook),
		...
		<div style="margin-bottom:50px">
			...
			<p style="padding-left:70px">
				<b>Louis A.</b><br />
				Designer de DreamVids, étudiant en info, passionné de basket, de sport et de voyage.
				Voilà ma vie en moins de 100 caractères. Suis-moi sur twitter aussi (@LowiSky_) !
			</p>
		</div>
		<div style="margin-bottom:50px">
			<div style="float:left">
		...
		<div style="margin-bottom:50px">
			...
			<p style="padding-left:70px">
				...
				J'ai intégré DreamVids avec la joie de découvrir une équipe soudée un peu loufoque sur les bords.
			</p>
		</div>
		<div style="margin-bottom:50px">
			<div style="float:left">
