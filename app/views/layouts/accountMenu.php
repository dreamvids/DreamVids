<nav class="tabs four">
	<ul>
		<li <?php echo (isset($current) && $current == 'account') ? 'class="current"' : ''; ?>><a href="<?php echo WEBROOT.'account'; ?>">Mon compte</a></li>
		...
		<li <?php echo (isset($current) && $current == 'channels') ? 'class="current"' : ''; ?>><a href="<?php echo WEBROOT.'channels'; ?>">Chaînes</a></li>
